...
def main():
    ...
    conv_handler = ConversationHandler(
        entry_points=[MessageHandler(Filters.text, noticeSearchGetInput)],

        states={
            SEARCH: [MessageHandler(Filters.text, noticeSearchStart)],
            ...
            ADDKEYWORD: [MessageHandler(Filters.text, NoticeAddSearch)],
