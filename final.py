    ...
    # 운영시간
        ...
        if '방학' in user_text:
            if '일반도서' in user_text:
                ...
                bot.send_message(chat_id=id, text='연중무휴 06:00 ~ 23:00')
            elif '제2' in user_text:
                bot.send_message(chat_id=id, text='평일: 06:00 ~ 23:00, 토요일: 휴관')
            ...
            bot.send_message(chat_id=id, text='방학 중 운영시간인지 학기 중 운영시간인지 정확하게 입력해주세요')
